...
@Entity
@Table(name = "MGM_EXPORT_FILE_REDEEM_POINT")
@JsonAutoDetect
@SequenceGenerator(allocationSize = 1, name = "seq_export_redeem", sequenceName = "SEQ_EXPORT_REDEEM")
@Data
public class MgmExportFileRedeemPoint {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_export_redeem")
	@Column(name = "EXPORT_REDEEM_ID", length = 16)
	private Long exportRedeemId;
