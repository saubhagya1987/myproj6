...
public class BidderApproval {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "BIDDER_APPROVAL_SEQ")
	@SequenceGenerator(name = "BIDDER_APPROVAL_SEQ", sequenceName = "BIDDER_APPROVAL_SEQ")
	@Column(name = "BIDDER_APPROVAL_ID")
