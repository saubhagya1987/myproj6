...
@Entity
@Table(name = "CUSTOMERACTIVITYLOG")
@SequenceGenerator(allocationSize = 1, name = "seq_CustomerActivity_log", sequenceName = "SEQ_CUSTOMERACTIVITYLOG")
@JsonAutoDetect
public class CustomerActivityLog {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_CustomerActivity_log")
