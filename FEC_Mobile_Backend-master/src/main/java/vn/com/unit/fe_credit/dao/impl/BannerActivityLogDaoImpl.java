...
@Repository
public class BannerActivityLogDaoImpl extends GenericDAOImpl<BannerActivityLog, Long>
		implements BannerActivityLogDao {
	@Autowired
	...
	public long sumChart(List<String> list, String FromDay, String ToDay,
		...
		hql.append("select count(*) from BannerActivityLog ac ");
		String id = null;
	...
	@Override
	public List<BannerActivityLog> bannerActivityLogs(long type, long customerId) {
		// TODO Auto-generated method stub
		StringBuilder sql = new StringBuilder();
		sql.append("select ac.activityId as activityId ,ac.logCode as logCode ,ac.logDate as logDate,ac.descritption as descritption,ac.userType as userType,ac.type as type,ac.refeId as refeId,ac.userId as userId,ac.customerId  as customerId from BannerActivityLog ac where ac.customerId="
				+ customerId
				+ " and ac.userId="
		...
		query.setResultTransformer(Transformers.aliasToBean(BannerActivityLog.class));
		return query.list();
	}
}
