...
@Repository
public class CustomerActivityLogDaoImpl extends GenericDAOImpl<CustomerActivityLog, Long>
		implements CustomerActivityLogDao {
	@Autowired
	...
	public long sumChart(List<String> list, String FromDay, String ToDay,
		...
		hql.append("select count(*) from CustomerActivityLog ac ");
		String id = null;
	...
	@Override
	public List<CustomerActivityLog> CustomerActivityLogs(long type, long customerId) {
		// TODO Auto-generated method stub
		StringBuilder sql = new StringBuilder();
		sql.append("select ac.activityId as activityId ,ac.logCode as logCode ,ac.logDate as logDate,ac.descritption as descritption,ac.userType as userType,ac.type as type,ac.refeId as refeId,ac.userId as userId,ac.customerId  as customerId from CustomerActivityLog ac where ac.customerId="
				+ customerId
				+ " and ac.userId="
		...
		query.setResultTransformer(Transformers.aliasToBean(CustomerActivityLog.class));
		return query.list();
	}
}
