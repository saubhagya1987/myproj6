...
@Repository
public class LoanActivityLogDaoImpl extends GenericDAOImpl<LoanActivityLog, Long>
		implements LoanActivityLogDao {
	@Autowired
	...
	public long sumChart(List<String> list, String FromDay, String ToDay,
		...
		hql.append("select count(*) from LoanActivityLog ac ");
		String id = null;
	...
	@Override
	public List<LoanActivityLog> loanActivityLogs(long type, long customerId) {
		// TODO Auto-generated method stub
		StringBuilder sql = new StringBuilder();
		sql.append("select ac.activityId as activityId ,ac.logCode as logCode ,ac.logDate as logDate,ac.descritption as descritption,ac.userType as userType,ac.type as type,ac.refeId as refeId,ac.userId as userId,ac.customerId  as customerId from LoanActivityLog ac where ac.customerId="
				+ customerId
				+ " and ac.userId="
		...
		query.setResultTransformer(Transformers.aliasToBean(LoanActivityLog.class));
		return query.list();
	}
}
