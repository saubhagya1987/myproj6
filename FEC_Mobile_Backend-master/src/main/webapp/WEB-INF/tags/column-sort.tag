...
<%@ attribute name="bean" required="true" rtexprvalue="true" type="vn.com.unit.fe_credit.bean.AbstractBean" description="AbstractBean support binding sort"%>
...
<%@ taglib tagdir="/WEB-INF/tags" prefix="ext" %>
				...
				<a href="javascript:submitAndSetHiddenVal('${formId}',{'dir':'${path}','sort':'${bean.sort=='asc'?'desc':'asc' }'})" style="color: #fff;">${fieldName } 
