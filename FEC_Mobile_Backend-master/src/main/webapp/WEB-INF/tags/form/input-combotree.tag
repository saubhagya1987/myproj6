...
<%@ attribute name="url" required="true" rtexprvalue="true" type="java.lang.String" description="url"%>
...
<div class="control-group">
			...
			<div class="controls">
				<form:input path="${path }" cssClass="${cssInput} easyui-combotree" id="${id }" disabled="${disable }"/>
