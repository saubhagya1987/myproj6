...
<div class="control-group">
					<textarea data-provide="${dataprovide }" ${tagreadonly } autocomplete="off" ${defaultvalueTag} name="${text }" id="${text }" 
				 ${disableTag } class="${cssInput}" style="width: 100px" value="${displayvalue}"></textarea>
...
<div class="control-group">
			...
			<div class="controls">
				...
				<textarea data-provide="${dataprovide }" autocomplete="off" ${tagreadonly } ${defaultvalueTag} name="${text }" id="${text }" class="${cssInput}" ${disableTag }></textarea>
