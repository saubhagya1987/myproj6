...
<%@ attribute name="path" required="false" rtexprvalue="true" type="java.lang.String" description="Path to binding"%>
<%@ attribute name="label" required="false" rtexprvalue="true" type="java.lang.String" description="Label name"%>
<%@ attribute name="placeholder" required="false" rtexprvalue="true" type="java.lang.String" description="place holder"%>
...
<%@ attribute name="functionComplete" required="false" rtexprvalue="true" type="java.lang.String" description="functionComplete update"%>
...
<div class="control-group">
				 ...
				 <input id="${text }${id }" type="hidden" value="${hiddenvalue}"/>
...
<!-- 			</label> -->
			<div class="controls">
					...
					<input type="text" data-provide="${dataprovide }" autocomplete="off" ${tagreadonly } ${defaultvalueTag} name="${text }" id="${text }" class="${cssInput}" ${disableTag } placeholder="${placeholder}"/>
					<input id="${text }${id }" type="hidden" value="${hiddenvalue}"/>
