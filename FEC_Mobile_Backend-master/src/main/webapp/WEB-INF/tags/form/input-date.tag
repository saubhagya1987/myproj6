...
<c:when test="${isGrid}">
				...
				<div class="input-append date" id="${id}" data-date="${value}"
													...
													<input class="span12 ${cssInput }" size="16" type="text" 
														name="${path}" value="${value}" placeholder="${ placeholder}"  ${disableTxt} id="${inputId }" style="width: ${csswidth}px"> <span class="add-on"><i
				...
				<span class="help-inline ${error_clss}_msg">
					...
					<form:errors path="${path}" cssClass="error" cssErrorClass="${cssInput} errorfeborder" cssStyle="padding-left:25px;"></form:errors>
				</span>
...
<div class="control-group">
			...
			<div class="controls">
				<div class="input-append date" id="${id}" data-date="${value}"
													data-date-format="${ format}">
													<input class="span12" size="37" type="text"
														name="${path}" value="${value}" placeholder="${ placeholder}" ${disableTxt} id="${inputId }" > <span class="add-on"><i
														class="icon-calendar"></i></span>
				</div>
				<c:if test="${disable}">
				<input type="hidden" id="${inputHidenId }" name="${path}" value="${value}"  />
