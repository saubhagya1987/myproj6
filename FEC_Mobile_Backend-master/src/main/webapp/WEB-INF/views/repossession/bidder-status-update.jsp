...
<script>
	...
	function update_status() {
		...
		ajaxUrl = '${url}/contract/repossession/updateBidderStatus';
			...
			success : function(result) {
				if(result!=null && result.info!=""){
					...
					var alertboxPopup = true;
					 ...
					 setTimeout(function(){ 
							window.location.replace("${url}/contract/repossession/viewBidder");
							 }, 3000);
				}
	...
	function backBidderData(contractId, repossessionId, bidder) { 
		document.location.href = "${url}/contract/repossession/viewBidder?contractId="+contractId+"&repossessionId="+repossessionId+"&bidder="+bidder;
	}
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<h4 style="padding: 8px 0 0 10px; margin:0px 0px 0px">
					...
					<a onclick="backBidderData('${sessionScope.bean.contractId}', ${sessionScope.bean.id}, ${sessionScope.bean.bidderId})" class="Color_back">Bidder</a><span> &gt; </span>
