...
<%-- <c:if test="${fn:length(beans.contractTerminationDtoList) > 0}">
	...
	<div class="row-fluid">
		...
		<div class="well_content row-fluid">
			...
			<c:if test="${fn:length(beans.terminatedContracts )<= 0}">
				...
				<c:forEach var="bean" items="${beans.terminatedContracts }"
											varStatus="i">
				...
				<div class="row-fluid">
                   ...
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.contractId" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.appleId }">
                   </div>
                   ...
                   <label for="penalty_fee" class="col_collection_view_left"><spring:message code="total.amount.paid" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="total_amount_paid"  value="${bean.totalAmountPaid }" >			
                   ...
                   <label for="early_termination" class="col_collection_view_left"> <spring:message code="loan.amount" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="loan_amount"  value="${bean.loanAmount }">
   													<script  type="text/JavaScript">
													        window.addEventListener("load", function () {
													        	
													        	        var x = $('#loan_amount').val();
													        	        $('#loan_amount').val(addCommas(x));
