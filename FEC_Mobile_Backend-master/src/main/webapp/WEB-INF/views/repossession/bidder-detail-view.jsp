...
<script>
	...
	function alert_button() {
		var alertboxPopup = true;
		 ...
		 setTimeout(function(){ 
				window.location.replace("${url}/contract/repossession/details");
				 }, 3000);
	...
	function attachment() {
		ajaxUrl = '${url}/contract/repossession/viewAttachments';
		$.ajax({
			url : ajaxUrl,
	...
	function backBidderData() {
		var contract = $('#contract_id').val();
		var repo = $('#contract_termination_id').val();
		document.location.href = "${url}/contract/repossession/viewBidder?contractId="+contract+"&repossessionId="+repo;
	}
		...
		<div class="row-fluid">
			<div class="span6">
				...
				<h4 style="padding: 8px 0 0 10px; margin:0px 0px 0px">
					...
					<a onclick="backBidderData()" class="Color_back">Bidder</a><span> &gt; </span>
...
<%-- <c:if test="${fn:length(beans.contractTerminationDtoList) > 0}">
	...
	<div class="row-fluid">
		...
		<div class="well_content row-fluid">
			...
			<c:if test="${fn:length(beans.bidderList )<= 0}">
				...
				<c:forEach var="bean" items="${beans.bidderList }"
											varStatus="i">
				
				
				<c:if test="${bean.id == beans.id}" >
				...
				<div class="row-fluid">
                   ...
                   <label for="contract_termination_id" class="col_collection_view_left"><spring:message code="contract.repossession.id" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_termination_id"  value="${bean.id }">
                   </div>
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.contractId" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.applId }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.amount" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.amount }">
                   </div>
                   
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.approvedDate" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.approvedDate }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.bidderName" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.bidderName }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.entryDate" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.entryDate }">
                   </div>
                   </div>
                   ...
                   <div class="span5">
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.idNumber" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.idNumber }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.phoneNumber" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.phoneNumber }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.requestDate" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.requestDate }">
                   </div>
                   
                    <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.userApprove" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.userApprove }">
                   </div>
                   
                    <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.userRequest" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.userRequest }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="contract_id" class="col_collection_view_left"><spring:message code="repossession.status" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="contract_id"  value="${bean.status }">
                   </div>
                   </div>
                  
                   
                    <%-- <div class="form-area-section">
                   <label for="penalty_fee" class="col_collection_view_left"><spring:message code="total.amount.paid" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="penalty_fee"  value="${bean.totalAmountPaid }" >
                   </div>
                   
                   <div class="form-area-section">
                   <label for="early_termination" class="col_collection_view_left"> <spring:message code="loan.amount" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="early_termination"  value="${bean.loanAmount }">
                   </div>
                   
                   
                   <div class="form-area-section">
                   <label for="middle_name" class="col_collection_view_left"> <spring:message code="customer.name" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="middle_name" placeholder="abcdefg" value="${bean.customerName }">
                   </div>
                   ...
                   <div class="form-area-section">
                   <label for="bucket" class="col_collection_view_left"> <spring:message code="repossession.address" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="bucket"  value="${bean.repossessionAddress }">
                   </div>
                   <div class="form-area-section">
                   ...
                   <label for="principle_outstanding" class="col_collection_view_left"> <spring:message code="principle.outstanding" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="principle_outstanding"  value="${bean.principalOutstanding }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="overdue_charges" class="col_collection_view_left"> <spring:message code="customers.phone" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="overdue_charges"  value="${bean.customersPhone }">
                   </div>
                   
                    <div class="form-area-section">
                   <label for="interest_outstanding" class="col_collection_view_left"><spring:message code="approver.level" /> </label>
   					<input type="text" class="form-control col_collection_view_right" id="interest_outstanding"  value="${bean.approverLevel }">
                   </div>
                   
                     <div class="form-area-section">
                   <label for="prepayment_penalty" class="col_collection_view_left"> <spring:message code="next.approver.level" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="prepayment_penalty"  value="${bean.nextApproverLevel }">
                   </div> 
                   
                   <div class="form-area-section">
                   <label for="refund" class="col_collection_view_left"> <spring:message code="approval.status" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="refund"  value="${bean.approvalStatus }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="inter_fund" class="col_collection_view_left"> <spring:message code="asset.condition" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="inter_fund"  value="${bean.assetCondition }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="total_amount_paid" class="col_collection_view_left"><spring:message code="brand" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="total_amount_paid"  value="${bean.brand }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="billed_inst" class="col_collection_view_left"> <spring:message code="financial.condition.assessment" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="billed_inst"  value="${bean.financialConditionAssessment }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="phone_number" class="col_collection_view_left"> <spring:message code="approved.date" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="phone_number"  value="${bean.approvedDate }">
                   </div>
                   <div class="form-area-section">
                   ...
                   <label for="inter_fund" class="col_collection_view_left"> <spring:message code="inter.fund" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="inter_fund"  value="${bean.approverLevel }">
                   </div>
                   
                    <div class="form-area-section">
                   <label for="reason" class="col_collection_view_left"> <spring:message code="unit.desc" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="reason"  value="${bean.unitDesc }">
                   </div>
                   
                   <div class="form-area-section">
                   <label for="change_off_flag" class="col_collection_view_left"> <spring:message code="repossession.suggestions" /></label>
   					<input type="text" class="form-control col_collection_view_right" id="change_off_flag"  value="${bean.suggestions }">
                   </div> --%>
                   
                 <%--   <div class="view-attechment-link">
                  <a href="${url}/contract/repossession/viewAttachments"><spring:message code="view.attachment" /></a> --%>
                  ...
                  <div class="text-bidder1-center-area-left">
								...
								<button type="button"  class="btn_back_general" name="back" onclick="backBidderData();"> <a href="#" >Back</a></button>
