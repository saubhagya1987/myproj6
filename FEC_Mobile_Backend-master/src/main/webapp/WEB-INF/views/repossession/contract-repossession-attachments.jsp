									...
									<div class="table-responsive1">
														...
														<td>
															<div class="edit-section-res">
																<ul>
																	<li>
																		<div class="view">
																			<a href="${url}/contract/repossession/downloadAttachment/${attachment.attachmentId}">
										...
										<script>
											...
											function handleAction(attachmentId){
												...
												ajaxUrl = '${url}/contract/repossession/downloadAttachment/' + attachmentId;
												$.ajax({
													url : ajaxUrl,
													type : 'GET',
													error: function() {
