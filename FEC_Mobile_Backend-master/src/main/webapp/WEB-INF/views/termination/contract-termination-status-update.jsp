...
<script>
	...
	function update_status() {
		...
		ajaxUrl = '${url}/contract/termination/updateStatus';
...
<div class="messages">
				...
				<div class="row-fluid ">
                    ...
                    <div class="text-center-area_pop">
                                ...
                                <button type="button" class="btn_cancel_general" name="cancel"><a href="${url}/contract/termination/view"> Cancel</a></button>
							</div>
                     <!--change html 25-11-16-->
