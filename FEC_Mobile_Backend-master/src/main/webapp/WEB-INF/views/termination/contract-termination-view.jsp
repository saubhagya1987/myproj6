		...
		<div class="row-fluid">
			<div class="span6">
				...
				<h4 style="padding: 8px 0 0 10px; margin:0px 0px 0px">
					...
					<span class="Color_back">Termination</span>
				</h4>
			</div>
...
<div class="container-fluid change_unit_bg_content">
    ...
    <!-- change html 25-11-16 -->
		...
		<div class="span6 title_h2_area">
			...
			<spring:message code="contract.termination" />
                    ...
                    <div class="table-responsive ">
  						<table class="table reposs table-hover">
  									 ...
  									 <tr>
	  									 ...
	  									 <th><spring:message code="customer.customerName" /></th>
	  									 <th><spring:message code="customer.approverLevel" /></th>
	  									 <th><spring:message code="customer.payer" /></th>
        								...
        								<c:choose>
        								 <c:when test="${fn:length(bean.contractTerminationDtoList ) <= 0}">
        							...
        							<c:otherwise>
        								<c:forEach var="contractTerminationList" items="${bean.contractTerminationDtoList }"
											varStatus="i">
											<%-- <p><c:out value="${fn:length(beans.contractTerminationDtoList)}"/></p>  --%>
											<tr>
										
												<%-- <td class="w50_stt text_center">${(bean.page-1)*bean.limit+i.index+1}</td> --%>
												<td><c:out value="${contractTerminationList.contractId }"></c:out></td>
												<td><c:out value="${contractTerminationList.customerId }"></c:out></td>
												<td><c:out value="${contractTerminationList.customerName }"></c:out></td>
												<td><c:out value="${contractTerminationList.approverLevel }"></c:out></td>												
												<td><c:out value="${contractTerminationList.payer }"></c:out></td>
												...
												<td>
			                                        ...
			                                        <a href="${url}/contract/termination/details?contractId=${contractTerminationList.contractId}&contractTerminationId=${contractTerminationList.contractTerminationId}"><img src="${url}/static/images/view.png" alt=""/></a><br/>View</div>
			                                        </li>
			                                        <sec:authorize access="hasAnyRole('CA','DOC','HOP','HOF', 'CRO')">
			                                        <li>
			                                        <div class="change-status-collection">
			                                        <a href="${url}/contract/termination/status?contractId=${contractTerminationList.contractId}&contractTerminationId=${contractTerminationList.contractTerminationId}"><img src="${url}/static/images/status.png" alt=""/></a><br/>Status<br/>Change
			                                        </div>
			                                        </li>
			                                        </sec:authorize>
			                                        ...
			                                        <input type="hidden" id="reassign_url_${i.index}" value="${url}/contract/termination/reassign?contractId=${contractTerminationList.contractId}&contractTerminationId=${contractTerminationList.contractTerminationId}&nextApproverLevel=${contractTerminationList.nextApproverLevel}"/>
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body assign-content">
        <p>Are you sure want to reassign Next Level</p>
      </div>
