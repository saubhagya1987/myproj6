...
<script>
	...
	function newItem() {
		document.location.href = "${url}/system/module/edit";
	}
	function importItem() {
...
<div class="title_top">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<spring:message var="menu_system_account_list" code="account.page.module.title"></spring:message>
...
<div class="container-fluid unit_bg_content">
		<div class="row-fluid">
			<div class="span6 title_h2">
				<h2>
					<spring:message var="list_title" code="account.page.module.title"></spring:message>
									...
									<div class="span12">
										<div class="span6">
											...
											<ext-form:input-text path="entity.name" cssInput="span10"
												labelCode="module.field.name"></ext-form:input-text>
										</div>
								...
								<thead>
									...
									<tr>
										...
										<th><spring:message var="msg_username"
												code="module.field.name"></spring:message>${msg_username}</th>
										<th><spring:message code="module.field.desc"></spring:message></th>
											...
											<tr>
												...
												<spring:message var="icon_delete" code="icon.delete"></spring:message>
												 ...
												 <td class="table-actions"><a
													href="${url}/system/module/edit?id=${_account[2] }"
