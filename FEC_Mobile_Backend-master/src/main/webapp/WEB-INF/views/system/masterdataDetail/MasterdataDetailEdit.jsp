...
<form:form method="POST" id="hobby_edit" cssClass="form-horizontal margin_bottom_form" modelAttribute="bean">
	...
	<div class="modal-header">
		...
		<h3 id="myModalLabel">
			<spring:message var="edit_title" code="${not empty bean.entity.masterdatadetailId?'MasterdataDetail.edit':'MasterdataDetail.new' }" />
	...
	<div class="modal-body">
		...
		<div class="span6">
				...
				<div class="control-group">
					<label for="type" class="control-label"> <spring:message code="menu.master" />
					</label>
					<div class="controls">

						<form:select id="masterdata_masterdataId" cssClass=""  path="entity.masterdata.masterdataId">
							<c:forEach items="${bean.listMasterdata}" var="j">
								<form:option value="${j.masterdataId}">${j.name}</form:option>
							</c:forEach>
						</form:select>
	...
	<form:hidden path="entity.masterdatadetailId" />
</form:form>
