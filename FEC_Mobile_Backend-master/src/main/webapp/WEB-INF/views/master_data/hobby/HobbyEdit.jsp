...
<form:form method="POST" id="hobby_edit" cssClass="form-horizontal margin_bottom_form" modelAttribute="bean">
	...
	<div class="modal-header">
		...
		<h3 id="myModalLabel">
			<spring:message var="edit_title" code="${not empty bean.entity.hobbyId?'hobby.edit':'hobby.AddNew' }" />
	...
	<div class="modal-body">
		...
		<div class="row-fluid">
			...
			<div class="span6">
				<ext-form:input-text path="entity.code" required="true" cssInput="span10" labelCode="hobby.Code" uppercase="true"id="entity_code" ></ext-form:input-text>
		...
		<div class="row-fluid">
			<div class="span6">
				<div class="control-group">
					<label for="type" class="control-label"> <spring:message code="hobby.Status" />
					</label>
					<div class="controls">
						<form:select path="entity.status">
							<form:option value="Activated">Activated</form:option>
							<form:option value="Inactivated">Inactivated</form:option>
						</form:select>
					</div>
				</div>
			</div>
	...
	<form:hidden path="entity.hobbyId" />
</form:form>
