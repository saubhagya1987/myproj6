...
<div class="title_top">
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<spring:message var="menu_banner_addnew" code="${not empty bean.entity.bannerId?'banner.view.title':'menu.banner.addnew' }"></spring:message>
...
<div class="container-fluid unit_bg_content">
		...
		<div class="row-fluid">
			<div class="span6 title_h2">
				<h2>
					<spring:message var="edit_title" code="${not empty bean.entity.bannerId?'banner.view.title':'banner.add.title' }"></spring:message>
					${edit_title }
				</h2>
			</div>		
		</div>
				...
				<div class="accordion-inner">
					<div class="input-area">
						<div class="row-fluid">
							<div class="span6">
								<div class="control-group">
									<label class="control-label">
										<spring:message code="banner.field.category" />&nbsp;
									</label>
									<div class="controls">
										<form:select path="entity.category" class="span10" id="categoryId" disabled="true">
							...
							<div class="span6">
								<ext-form:input-text path="entity.bannerCode" cssInput="span10" labelCode="banner.field.code" id="bannerCodeId" disable="True"></ext-form:input-text>
							</div>
						</div>
						...
						<div class="row-fluid">
							<div class="span6">
								...
								<ext-form:input-date-time path="entity.activeFromDate" id="var_activefrom_id" inputId="var_activefrom" value="${var_activefrom}" labelCode="banner.field.active.from.date"  disable="true" />
							</div>
							<div class="span6">
								<fmt:formatDate var="var_activeto" value="${bean.entity.activeToDate}"	pattern="${sessionScope.formatDate} HH:mm"  />
								<ext-form:input-date-time path="entity.activeToDate" id="var_activeto_id" inputId="var_activeto" value="${var_activeto}" labelCode="banner.field.active.to.date" disable="true"/>
							</div>		
						</div>
						<div class="row-fluid">
							<div class="span6">
								<div class="control-group">
									...
									<div class="controls">	
										...
										<input type="text" id="slidePeriod" onchange="myFormatNumber('slidePeriod')" class="text_right number" style="width: 140px;"  
											value="${slidePeriod}" name="entity.slidePeriod" disabled="disabled" />&nbsp;<spring:message code="banner.msg.millisecond"></spring:message>
										<span class="help-inline">	
							...
							<div class="span6">
								<div class="control-group">
									...
									<div class="controls">
										<form:select path="entity.status" class="span10" itemValue="languageId" disabled="true">
								...
								<div class="control-group">
									...
									<div class="controls">	
										...
										<input type="text" id="orderbanner" onchange="myFormatNumber('orderbanner')" class="text_right number" style="width: 140px;"  
											value="${orderbanner}" name="entity.orderbanner"  disabled="True"/>
										<span class="help-inline">	
										</span>
									</div>	
								</div>
						...
						<div class="row-fluid">
							<ext-form:input-text path="entity.title" cssInput="width_area" labelCode="banner.field.title" disable="True"></ext-form:input-text>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="input-area">
						<div class="row-fluid">
							<div class="span10 offset1">
								<div>
									<c:if test="${empty bean.entity.bannerId}">
						...
						<input type="hidden" id="tagImageLinkShow" name="lstImageLink" value="${bean.lstImageLink }"/>
					</div>
				</div>
			</div>
		</div>	
...
$(document).ready(function() {
	...
	$("#var_activefrom").change(function(){
        var fromDate = $("#var_activefrom_id").datepicker( "getDate" );
           if(!$("#var_activefrom").val()){
                $("#var_activeto_id").datepicker("setStartDate", 0);
                return;
           }

           var toDate = $("#var_activeto_id").datepicker( "getDate" );
           if(toDate < fromDate){
                $("#var_activeto").val("");
           }
           $("#var_activeto_id").datepicker("setStartDate", fromDate);
     });
...
function loadSliderImage_b(lstImg, url, flag) {
	var lstImageLinkShow = $("#tagImageLinkShow").val();
	/* console.log(lstImageLinkShow + "++++++++++++++++++"); */
	ajaxUrl = url + '/ajax/showImageView?flag=' + flag + '&&listFile=' + lstImg +'&&lstImageLinkShow=' + lstImageLinkShow;
	$.ajax({
		url : ajaxUrl,
		cache : false,
