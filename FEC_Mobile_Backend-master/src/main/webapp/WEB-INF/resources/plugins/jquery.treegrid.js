...
if(_48){
_4b.queryPareprocurement=_48;
}
var _4d=$.extend({},_4b.queryPareprocurement);
if(_4b.pagination){
...
var cc=_7d.children("td").children("div");
cc.hide();
var _7f=$.extend({},_7c.queryPareprocurement||{});
...
_b1=$.extend({},_b0.queryPareprocurement);
_b1.id=id;
}
if(_b1.id){
