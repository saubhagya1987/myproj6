...
if(_5de){
opts.queryPareprocurement=_5de;
}
var _5df=$.extend({},opts.queryPareprocurement);
if(opts.pagination){
...
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryPareprocurement:{}}),$.fn.datagrid.parseOptions(this),_5e6);
...
if(_727){
opts.queryPareprocurement=_727;
}
var _72a=$.extend({},opts.queryPareprocurement);
if(opts.pagination){
...
var cc=_74c.children("td").children("div");
cc.hide();
var _74e=$.extend({},opts.queryPareprocurement||{});
...
_774=$.extend({},opts.queryPareprocurement);
_774.id=id;
}
if(_774.id){
...
opts.queryPareprocurement=_774;
...
if(opts.mode=="remote"){
grid.datagrid("clearSelections");
grid.datagrid("load",$.extend({},opts.queryPareprocurement,{q:q}));
}else{
if(!q){
return;
}
